...
static ERL_NIF_TERM get_status_nif(ErlNifEnv* env, int argc, const ERL_NIF_TERM argv[]) {
    ...
    switch (status_code) {
        case 0:  return make(env, am_success);
        case 1:  return make_tuple(env, am_error, am_general_error);
        case 2:  return make_tuple(env, am_error, am_timeout);
        case 42: return make(env, am_custom_event);
        default: return make_tuple(env, am_error, am_unknown_status);
    }
}
